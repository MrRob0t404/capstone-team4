...
INSERT INTO users (username, password_digest, email, profilePic, stack, bio)
    VALUES ('Tyler', '$2a$10$brAZfSmByFeZmPZ/MH5zne9YDhugjW9CtsBGgXqGfix0g1tcooZWq', 'email@email.com', 'http://www.personalbrandingblog.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640-300x300.png', 'JS, React, Pug, HTML, CSS', 'I like to code'),
         ('Chancellor', '$2a$10$brAZfSmByFeZmPZ/MH5zne9YDhugjW9CtsBGgXqGfix0g1tcooZWq', 'email@email.com', 'http://www.personalbrandingblog.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640-300x300.png', 'Python, C++, Machine Learning', 'I like to code its fun'),
         ('Victoria', '$2a$10$brAZfSmByFeZmPZ/MH5zne9YDhugjW9CtsBGgXqGfix0g1tcooZWq', 'email@email.com', 'http://www.personalbrandingblog.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640-300x300.png', 'HTML', 'coding is the best like omg'),
         ...
         ('fart', '$2a$10$noryJFgByFccCS/F6XILSeqM.3TqBhmRJ0QtAMPHtlzriqk6rsY8S', 'email@email.com', 'http://www.personalbrandingblog.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640-300x300.png', 'Ruby', 'I enjoy farting around, when I can I try to fart as much as I can');
         
INSERT INTO problem (description, problemPoster, problemSnippet, githubRepo)
    VALUES ('Problem with for loop', 2, 'forvar i  0 i < arr.length i++){ fail }', 'https://github.com/mon33k'),
           ('I cant import this font', 3, '@import comic sans ERR', 'https://github.com/mon33k'),
           ('Whenever I rerender my routes dont work', 4, '<Link exact path= />', 'https://github.com/mon33k' ),
